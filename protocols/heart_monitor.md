...
Therefore the resistance is `R = V_R/I_F`. So, in our case, `R = 60 Ω`, which means we should be able to use a 68 Ω resistor.
...
In our case, a 100 kΩ resistor should give a satisfying range of results.  
...
4. Plug the circuit on. *Use the 5V pin* instead of the digital pin as it will allow you to see the heart beating much better.
